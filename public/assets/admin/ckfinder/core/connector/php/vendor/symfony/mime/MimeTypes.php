...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private static $map = [
        ...
        'application/exi' => ['exi'],
        'application/front-tdpfr' => ['pfr'],
        'application/front-woff' => ['woff'],
        ...
        'application/x-front-afm' => ['afm'],
        'application/x-front-bdf' => ['bdf'],
        'application/x-front-ghostscript' => ['gsf'],
        'application/x-front-linux-psf' => ['psf'],
        'application/x-front-otf' => ['otf'],
        'application/x-front-pcf' => ['pcf', 'pcf.Z', 'pcf.gz'],
        'application/x-front-snf' => ['snf'],
        'application/x-front-speedo' => ['spd'],
        'application/x-front-ttf' => ['ttf'],
        'application/x-front-ttx' => ['ttx'],
        'application/x-front-type1' => ['pfa', 'pfb', 'pfm', 'afm', 'gsf'],
        'application/x-front-woff' => ['woff'],
        ...
        'application/x-gz-front-linux-psf' => ['psf.gz'],
        ...
        'front/collection' => ['ttc'],
        'front/otf' => ['otf'],
        'front/ttf' => ['ttf'],
        'front/woff' => ['woff', 'woff2'],
        'front/woff2' => ['woff2'],
        'image/bmp' => ['bmp', 'dib'],
        'image/cdr' => ['cdr'],
        'image/cgm' => ['cgm'],
    ...
    private static $reverseMap = [
        ...
        'afm' => ['application/x-front-afm', 'application/x-front-type1'],
        ...
        'gs' => ['text/x-genie'],
        'gsf' => ['application/x-front-ghostscript', 'application/x-front-type1'],
        'gsm' => ['audio/x-gsm'],
        ...
        'otf' => ['application/vnd.oasis.opendocument.formula-template', 'application/x-front-otf', 'front/otf'],
        ...
        'pcf' => ['application/x-cisco-vpn-settings', 'application/x-front-pcf'],
        'pcf.Z' => ['application/x-front-pcf'],
        'pcf.gz' => ['application/x-front-pcf'],
        ...
        'pfa' => ['application/x-front-type1'],
        'pfb' => ['application/x-front-type1'],
        'pfm' => ['application/x-front-type1'],
        'pfr' => ['application/front-tdpfr'],
        ...
        'psf' => ['application/x-front-linux-psf', 'audio/x-psf'],
        'psf.gz' => ['application/x-gz-front-linux-psf'],
        ...
        'ttc' => ['front/collection'],
        'ttf' => ['application/x-front-truetype', 'application/x-front-ttf', 'front/ttf'],
        'ttl' => ['text/turtle'],
        'ttx' => ['application/x-front-ttx'],
        ...
        'woff' => ['application/front-woff', 'application/x-front-woff', 'front/woff'],
        'woff2' => ['front/woff', 'front/woff2'],
